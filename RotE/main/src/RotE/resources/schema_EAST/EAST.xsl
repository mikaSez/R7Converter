...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Declaration HTML5 -->
    <xsl:output method="xml" omit-xml-declaration="yes" encoding="UTF-8" doctype-system="about:legacy-compat"
                indent="yes"/>

    <!-- options (valeurs: oui|non) -->
    <xsl:param name="commentaires">
        <xsl:choose>
            <xsl:when test="/EAST/PREFERENCES/REGLAGES/COMMENTAIRES">
                <xsl:value-of select="/EAST/PREFERENCES/REGLAGES/COMMENTAIRES"/>
            </xsl:when>
            <xsl:otherwise>non</xsl:otherwise>
        </xsl:choose>
    </xsl:param>

    <xsl:param name="impression">
        <xsl:choose>
            <xsl:when test="/EAST/PREFERENCES/REGLAGES/IMPRESSION">
                <xsl:value-of select="/EAST/PREFERENCES/REGLAGES/IMPRESSION"/>
            </xsl:when>
            <xsl:otherwise>non</xsl:otherwise>
        </xsl:choose>
    </xsl:param>
    ...
    <xsl:template match="PAGE_TITRE">
        ...
        <div class="slide" id="cover">
            <table width="100%">
                ...
                <tr>
                    <td align="left" class="vingt logogauche">
                        <xsl:apply-templates select="../LOGO_GAUCHE"/>
                    </td>
                    <!-- <td align="center" class="soixante"> </td> -->
                    <td/>
                    <td align="right" class="vingt logodroit">
                        <tt>
            ...
            <table class="bas" width="100%">
                <tr>
                    ...
                    <td align="center" class="tiers">
                        <tt class="slidenumber">
                            <xsl:value-of select="DATE_EXPOSE"/>
                        </tt>
                    </td>
                    <td align="right" class="tiers">
                        <tt class="pieddroit">
                            <xsl:apply-templates select="../PIEDPAGE_DROIT"/>
                        </tt>
                    </td>
                </tr>
            </table>
    ...
    <xsl:template match="PARTIE">
        ...
        <xsl:variable name="nbpart">
            <xsl:value-of select="count(preceding::PARTIE)+1"/>
        </xsl:variable>
    ...
    <xsl:template name="sommaire">
        ...
        <div class="slide" id="sommaire">
            ...
            <table width="100%">
                ...
                <tr>
                    <td align="left" class="vingt">
                        <xsl:apply-templates select="LOGO_GAUCHE"/>
                    </td>
                    <td align="center" class="soixante">
                        <h1 class="titresommaire">Plan</h1>
                    </td>
                    <td align="right" class="vingt">
                        <tt>
                            <xsl:apply-templates select="LOGO_DROIT"/>
                        </tt>
                    </td>
            ...
            <xsl:if test="count(METADONNEES/AUTEUR)&gt;0">
                <div class="auteur">-
                    <xsl:apply-templates select="METADONNEES/AUTEUR"/>
                </div>
            </xsl:if>
                                    ...
                                    <xsl:variable name="nbsec2">
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                ...
                                                <xsl:value-of
                                                        select="count(preceding::SECTION)+count(preceding::PAGE_TITRE)"/>
        ...
        <html>
            <head>
                ...
                <xsl:choose>
                    <xsl:when test="normalize-space(PAGE_TITRE/TITRE)!=''">
                        <title>
                            <xsl:value-of select="PAGE_TITRE/TITRE"/>
                        </title>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <link rel="stylesheet" type="text/css" href="config_EAST/EAST_transitions.css">
                    <xsl:text> </xsl:text>
                </link>
                <link rel="stylesheet" type="text/css" href="config_EAST/EAST.css">
                    <xsl:text> </xsl:text>
                </link>
                <link rel="stylesheet" type="text/css" href="config_EAST/EAST_config.css">
                    <xsl:text> </xsl:text>
                </link>
                <!-- <link rel="stylesheet" type="text/css" href="config_EAST/EAST_theme.css"><xsl:text> </xsl:text></link> -->
                <link rel="timesheet" type="application/smil+xml" href="config_EAST/EAST.smil">
                    <xsl:text> </xsl:text>
                </link>
                <link rel="stylesheet" href="config_EAST/Highlight/styles/default.css"></link>


                <script type="text/javascript" src="config_EAST/EAST.js">
                    <xsl:text> </xsl:text>
                </script>
                <script type="text/javascript" src="config_EAST/BrowserDetect.js">
                    <xsl:text> </xsl:text>
                </script>
                <script type="text/javascript" src="config_EAST/timesheets.js">
                    <xsl:text> </xsl:text>
                </script>
                <script type="text/javascript" src="config_EAST/timesheets-navigation.js">
                    <xsl:text> </xsl:text>
                </script>
                <script type="text/javascript" src="config_EAST/EAST_session.js">
                    <xsl:text> </xsl:text>
                </script>
                <script type="text/javascript" src="config_EAST/Highlight/highlight.pack.js">
                    <xsl:text> </xsl:text>
                </script>
            ...
            <body class="{$body_transition}" style="font-size: 100%">
                ...
                <div id="slideshow">
                    ...
                    <xsl:if test="PAGE_CONCLUSION">
                        <xsl:apply-templates select="PAGE_CONCLUSION"/>
                    </xsl:if>
                ...
                <div id="erreur">
                    ...
                    <ul>
                        <h3>Francais</h3>
                        <li>La configuration de EAST n'a pas été trouvée et cela empêche le fonctionnement normal de
                            EAST.
                        </li>
                        <li>Pour corriger ce probleme, placez le répertoire
                            <em>config_EAST</em>
                            à côté de votre fichier HTML dans le même répertoire et rechargez votre fichier HTML
                        </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>To fix this problem, just put the directory
                            <em>config_EAST</em>
                            beside your HTML file in the same directory and reload your HTML file
                        </li>
                    </ul>
                </div>
    ...
    <xsl:template name="css">
        ...
        <xsl:if test="$fontpage!=''">; font-family: "<xsl:value-of select="$fontpage"/>"
        </xsl:if>
        }

        #slideshow { font-size: 1.5em }

        h1 { text-align: center; font-size: 150%; font-family:
        <xsl:if test="$fontpage!=''">"<xsl:value-of select="$fontpage"/>",
        </xsl:if>
        sans-serif; color: #963232 }
        h2 { text-align: center; font-size: 110%; font-weight: bold; font-family:
        <xsl:if test="$fontpage!=''">"<xsl:value-of select="$fontpage"/>",
        </xsl:if>
        sans-serif; color: #963232 }
        h3 { font-size: 100%; font-weight: bold; font-family:
        <xsl:if test="$fontpage!=''">"<xsl:value-of select="$fontpage"/>",
        </xsl:if>
        serif; margin-bottom: 0.5em }
        h5 { text-align: center; font-size: 90%; font-weight: bold; font-family:
        <xsl:if test="$fontpage!=''">"<xsl:value-of select="$fontpage"/>",
        </xsl:if>
        serif; margin-bottom: 0.5em; color: #963232 }
        h6 { text-align: center; font-size: 70%; font-weight: bold; font-family:
        <xsl:if test="$fontpage!=''">"<xsl:value-of select="$fontpage"/>",
        </xsl:if>
        serif; margin-bottom: 0.5em; color: #963232 }
        .auteur { text-align: center }
        .date { text-align: left }
        .sommaire { page-break-after: always; background: #F5F5FF; margin: 0.5em; padding: 0.5em;
        <xsl:if test="$impression='non'">border: gray outset</xsl:if>
        }
        .cover { page-break-after: always; background: #F5F5FF; margin: 0.5em; padding: 0.5em;
        <xsl:if test="$impression='non'">border: gray outset</xsl:if>
        }
        .conclusion { page-break-after: always; background: #F5F5FF; margin: 0.5em; padding: 0.5em;
        <xsl:if test="$impression='non'">border: gray outset</xsl:if>
        }
        .section { page-break-after: always; background: #FFFFEB; margin: 2em 0.5em; padding: 0.5em;
        <xsl:if test="$impression='non'">border: gray outset</xsl:if>
        }
        ...
        <xsl:choose>
            <xsl:when test="/EAST/PREFERENCES/PAGE/@image">
                ...
                .slide { page-break-after: always; margin: 2em 0.5em; padding: 0.5em;
                <xsl:if test="$impression='non'">border: gray outset;</xsl:if>
                background-size: cover; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size:
                cover; background-image: url('<xsl:value-of select="normalize-space(/EAST/PREFERENCES/PAGE/@image)"/>');}
            ...
            <xsl:otherwise>
                ...
                .slide { page-break-after: always; background: <xsl:value-of select="$fondpage"/>; margin: 2em 0.5em;
                padding: 0.5em;
                <xsl:if test="$impression='non'">border: gray outset</xsl:if>
                }
        ...
        color:
        <xsl:value-of select="$titlepagecolor"/> ;
        <xsl:if test="$titlepageback!=''">background :
            <xsl:value-of select="$titlepageback"/> ;
        </xsl:if>
        <xsl:if test="/EAST/PREFERENCES/TITLE_PAGE/@image">background-image: url('<xsl:value-of
                select="/EAST/PREFERENCES/TITLE_PAGE/@image"/>') ;
        </xsl:if>
        <xsl:if test="/EAST/PREFERENCES/TITLE_PAGE/@font">font-family:
            <xsl:value-of select="/EAST/PREFERENCES/TITLE_PAGE/@font"/> ;
        </xsl:if>
        }
        ...
        .titreimage { text-align: center; font-weight: bold; background-color:
        <xsl:value-of select="$fondtitre"/> ;
        <xsl:if test="$fontitre!=''">font-family:
            <xsl:value-of select="$fontitre"/>
        </xsl:if>
        ; color: <xsl:value-of select="$titlecolor"/>}
        .envimage { text-align: center; border: gray outset; padding: 0; margin: 1em; background:
        <xsl:value-of select="$fondenv"/>
        <xsl:if test="$imagenv!=''">; background-image: url(<xsl:value-of select="$imagenv"/>)
        </xsl:if>
        }
        .legende { font-family:
        <xsl:if test="$fontenv!=''">"<xsl:value-of select="$fontenv"/>",
        </xsl:if>
        sans-serif; margin-top: 1em ; color: <xsl:value-of select="$colorenv"/>}
        ...
        .elsommaire { font-size: 110%; color:
        <xsl:value-of select="$colorpage"/> ; text-decoration: none; font-weight: bold }
        .elsommaire:hover { font-size: 110%; color: <xsl:value-of select="$linkpage"/>; text-decoration: none;
        font-weight: bold }
        .elsommaire2 { font-size: 110%; color:
        <xsl:value-of select="$colorpage"/> ; text-decoration: none}
        .elsommaire2:hover { font-size: 110%; color: <xsl:value-of select="$linkpage"/>; text-decoration: none }
        <xsl:if test="/EAST/PREFERENCES/PAGE/@linkcolor!=''">.linkitem { color:
            <xsl:value-of select="$colorpage"/> }
        </xsl:if>
        <xsl:if test="/EAST/PREFERENCES/PAGE/@linkcolor!=''">.linkitem:hover { color:
            <xsl:value-of select="/EAST/PREFERENCES/PAGE/@linkcolor"/> }
        </xsl:if>
        ...
        th {
        background:
        <xsl:value-of select="$fondentete"/> ;
        color:
        <xsl:value-of select="$colorentete"/> ;
        <xsl:if test="/EAST/PREFERENCES/TABLES/TAB_ENTETE/@image">background-image: url(<xsl:value-of
                select="/EAST/PREFERENCES/TABLES/TAB_ENTETE/@image"/> ) ;
        </xsl:if>
        <xsl:if test="/EAST/PREFERENCES/TABLES/TAB_ENTETE/@font">font-family:
            <xsl:value-of select="/EAST/PREFERENCES/TABLES/TAB_ENTETE/@font"/> ;
        </xsl:if>
        }
        ...
        .tableau1 {
        background:
        <xsl:value-of select="$fondcorps"/> ;
        color:
        <xsl:value-of select="$colorcorps"/> ;
        <xsl:if test="/EAST/PREFERENCES/TABLES/TAB_CORPS/@image">background-image: url(<xsl:value-of
                select="/EAST/PREFERENCES/TABLES/TAB_CORPS/@image"/> ) ;
        </xsl:if>
        <xsl:if test="/EAST/PREFERENCES/TABLES/TAB_CORPS/@font">font-family:
            <xsl:value-of select="/EAST/PREFERENCES/TABLES/TAB_CORPS/@font"/> ;
        </xsl:if>
        }
        .tableau2 {
        background:
        ...
        ul { margin-top: 0.5em
        <xsl:if test="$fondcontenu!=''">; background :
            <xsl:value-of select="$fondcontenu"/>
        </xsl:if>
        <xsl:if test="$colorcontenu!=''">; color :
            <xsl:value-of select="$colorcontenu"/>
        </xsl:if>
        }
        ...
        tt.slidenumber { color :
        <xsl:value-of select="$colorpied"/>
        <xsl:if test="$fondcontenu!=''">; background :
            <xsl:value-of select="$fondcontenu"/>
        </xsl:if>
        }
        ...
        td.soixante { width: 60% ; background :
        <xsl:value-of select="/EAST/PREFERENCES/TITLES/@backcolor"/> }
        ...
        color :
        <xsl:value-of select="$titrecolor"/> ;
        <xsl:if test="/EAST/PREFERENCES/TITLES/@backcolor">background :
            <xsl:value-of select="/EAST/PREFERENCES/TITLES/@backcolor"/> ;
        </xsl:if>
        <xsl:if test="/EAST/PREFERENCES/TITLES/@image">background-image: url(<xsl:value-of
                select="/EAST/PREFERENCES/TITLES/@image"/> ) ;
        </xsl:if>
        <xsl:if test="/EAST/PREFERENCES/TITLES/@font">font-familiy :
            <xsl:value-of select="/EAST/PREFERENCES/TITLES/@font"/> ;
        </xsl:if>
    ...
    <xsl:template match="LOGO_GAUCHE">
        ...
        <xsl:choose>
            ...
            <xsl:when test="@url!=''">
                <a href="{@url}">
                    <img align="left" alt="{@alt}" border="0" src="{@fichier}" height="{@hauteur_SVG}%" title="{@alt}"
                         width="{@largeur_SVG}%"/>
                </a>
            </xsl:when>

            <xsl:otherwise>
                <img align="left" alt="{@alt}" src="{@fichier}" height="{@hauteur_SVG}%" title="{@alt}"
                     width="{@largeur_SVG}%"/>
            </xsl:otherwise>
    ...
    <xsl:template match="LOGO_DROIT">
        ...
        <xsl:choose>
            ...
            <xsl:when test="@url!=''">
                <a href="{@url}">
                    <img align="right" alt="{@alt}" border="0" src="{@fichier}" height="{@hauteur_SVG}%" title="{@alt}"
                         width="{@largeur_SVG}%"/>
                </a>
            </xsl:when>

            <xsl:otherwise>
                <img align="right" alt="{@alt}" src="{@fichier}" height="{@hauteur_SVG}%" title="{@alt}"
                     width="{@largeur_SVG}%"/>
            </xsl:otherwise>
    ...
    <xsl:template match="SECTION">
        ...
        <div class="slide" id="slide{$numero}">
            ...
            <xsl:variable name="sec_id">
                <xsl:value-of select="concat('slide',$numero)"/>
            </xsl:variable>
            ...
            <script type="text/javascript">
                ...
                var
                <xsl:value-of select="$sec_id"/> = document.getElementById("<xsl:value-of select="$sec_id"/>");
            ...
            <table class="bas" width="100%">
                <tr>
                    ...
                    <td align="center" class="tiers">
                        <tt class="slidenumber"><xsl:value-of select="$numero"/>/<xsl:value-of
    ...
    <xsl:template match="CODE_COLS">
        ...
        <xsl:variable name="npart">
            <xsl:value-of select="count(ancestor-or-self::PARTIE)"/>
        </xsl:variable>
        <xsl:variable name="nsect">
            <xsl:value-of select="count(preceding::SECTION)"/>
        </xsl:variable>
        <xsl:variable name="ncode">
            <xsl:value-of select="count(preceding-sibling::CODE_COLS)"/>
        </xsl:variable>


        <xsl:variable name="id_code">
            <xsl:value-of select="concat('d',$npart,$nsect,$ncode)"/>
        </xsl:variable>
    ...
    <xsl:template match="EMPHASE">
        ...
        <xsl:variable name="nlist">
            <xsl:value-of select="count(ancestor-or-self::LISTE)"/>
        </xsl:variable>
        <xsl:variable name="nitem">
            <xsl:value-of select="count(preceding::EL)"/>
        </xsl:variable>

        <xsl:variable name="id_span">
            <xsl:value-of select="concat('se',$npart,$nsect,$nlist,$nitem)"/>
        </xsl:variable>
        ...
        <script type="text/javascript">
            ...
            var
            <xsl:value-of select="$id_span"/> = document.getElementById("<xsl:value-of select="$id_span"/>");
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when test="normalize-space($list_type)!=''">
                                ...
                                <ul type="{$list_type}">
                                    ...
                                    <xsl:apply-templates select="EL"/>
                                    <li class="signeplus">
                                        <img src="config_EAST/signe_plus.png"/>
                                    </li>
                                </ul>
    ...
    <xsl:template match="EL">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$textlenght = 0 and count(child::*[name()!='LISTE']) = 0">
                <xsl:apply-templates/>
            </xsl:when>
            ...
            <xsl:otherwise>
                ...
                <xsl:variable name="id_el">
                    <xsl:value-of select="concat('l',$npart,$nsect,$nlist,$nitem)"/>
                </xsl:variable>
                <xsl:variable name="id_span">
                    <xsl:value-of select="concat('s',$npart,$nsect,$nlist,$nitem)"/>
                </xsl:variable>
                ...
                <xsl:choose>
                    ...
                    <xsl:when
                            test="normalize-space(../@image_puce)!='' or normalize-space(/EAST/PREFERENCES/PUCE[@level=$nlist]/@image)!='' or normalize-space(../@couleur_puce)!='' or normalize-space(/EAST/PREFERENCES/PUCE[@level=$nlist]/@colorpuce)!='' or normalize-space(/EAST/PREFERENCES/PUCE[@level=$nlist]/@colortexte)!='' or normalize-space(../@couleur_texte)!=''">
                        ...
                        <script type="text/javascript">
                            ...
                            var li<xsl:value-of select="$id_el"/> = document.getElementById("<xsl:value-of
                                select="$id_el"/>");
                            var span<xsl:value-of select="$id_span"/> = document.getElementById("<xsl:value-of
                                select="$id_span"/>");
                            ...
                            <xsl:if test="$imagepuce!=''">
                                ...
                                li<xsl:value-of select="$id_el"/>.style.listStyleImage = "url(<xsl:value-of
                                    select="$imagepuce"/>)";

                            </xsl:if>

                            <xsl:if test="$coltext!=''">span<xsl:value-of select="$id_span"/>.style.color =
                                "<xsl:value-of select="$coltext"/>";
                            </xsl:if>
    ...
    <xsl:template match="VIDEO">
        ...
        <xsl:variable name="controls">
            ...
            <xsl:choose>
                ...
                <xsl:when
                        test="normalize-space(@controls)!='' and normalize-space(@controls)!='false' and normalize-space(@controls)!='0'">
        ...
        <xsl:choose>
            ...
            <xsl:when test="normalize-space(@autoplay)!='' or normalize-space(@controls)!=''">
                ...
                <xsl:choose>
                    ...
                    <xsl:when
                            test="normalize-space(@autoplay)!='' and normalize-space(@autoplay)!='false' and normalize-space(@autoplay)!='0' and normalize-space(@controls)!='' and normalize-space(@controls)!='false' and normalize-space(@controls)!='0'">

                        <xsl:choose>

                            <xsl:when test="normalize-space(@hauteur)!='' or normalize-space(@largeur)!=''">

                                <video src="{@fichier}" width="{$width}" height="{$height}" preload="auto"
                                       poster="{$poster}" controls="true" autoplay="true">x
                                </video>
                            ...
                            <xsl:otherwise>
                                ...
                                <video src="{@fichier}" preload="auto" poster="{$poster}" controls="true"
                                       autoplay="true">x
                                </video>
                    ...
                    <xsl:when
                            test="normalize-space(@autoplay)!='' and normalize-space(@autoplay)!='false' and normalize-space(@autoplay)!='0' and normalize-space(@controls)=''">
                    ...
                    <xsl:when
                            test="normalize-space(@controls)!='' and normalize-space(@controls)!='false' and normalize-space(@controls)!='0' and normalize-space(@autoplay)=''">
    ...
    <xsl:template match="CT">
        ...
        <xsl:variable name="ltpos">
            <xsl:number count="LT" from="TABLEAU"/>
        </xsl:variable>
        ...
        <div align="center">
            ...
            <table border="0" cellspacing="10" class="envimage" style="{$alltabs}">
                ...
                <xsl:if test="normalize-space(TITRE)!=''">
                    ...
                    <tr>
                        <td>
                            <p class="titreimage" style="{$alltitres}">
                                <xsl:value-of select="TITRE"/>
                            </p>
                        </td>
                    </tr>
